...
us.personal.expenses <- data.frame(USPersonalExpenditure)

# What are the column names of your dataframe?

column.names <- colnames(us.personal.expenses)

# Why are they so strange? Think about whether you could use a number like 1940
# with dollar notation!

# What are the row names of your dataframe?
row.names <- rownames(us.personal.expenses)

# Create a column "category" that is equal to your rownames

us.personal.expenses$category <- row.names

# How much money was spent on personal care in 1940?

money.on.healthcare <- us.personal.expenses[4, 1]

# How much money was spent on Food and Tobacco in 1960?

money.on.food.tobacco <- us.personal.expenses[1, 5]

# What was the highest expenditure category in 1960?
# Hint: use the `max()` function to find the largest, then compare that to the column

highest.expenditure <- us.personal.expenses[max(us.personal.expenses)]
